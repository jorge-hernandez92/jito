...
<%--      <LINK HREF="<C:URL VALUE='/STATIC/CSS/BOOTSTRAP.CSS' />" REL="STYLESHEET"></LINK> --%>
  ...
  <div class="collapse navbar-collapse">
    <ul class="navbar-nav mr-auto mt-2 mt-lg-0">
            <li class="nav-item" ui-sref-active="active"><a class="nav-link" href="" ui-sref="home" >Inicio</a></li>
            <li class="nav-item" ui-sref-active="active"><a class="nav-link" href="" ui-sref="harvest" >Cosecha</a></li>
            <li class="nav-item" ui-sref-active="active"><a class="nav-link" href="" ui-sref="treatment">Tratamiento</a></li>
            <li class="nav-item" ui-sref-active="active"><a class="nav-link" href="" ui-sref="diseases">Enfermedades</a></li>
            <li class="nav-item" ui-sref-active="active"><a class="nav-link" href="" ui-sref="investment">Inversión</a></li>
            <li class="nav-item" ui-sref-active="active"><a class="nav-link" href="" ui-sref="plant">Planta</a></li>
    </ul>
    <form class="form-inline my-2 my-lg-0">
      <button type="button" class="btn btn-outline-secondary my-2 my-sm-0" ng-click="ctrl.btnLogout()">Cerrar Sesión</button>
    </form>
  </div>
</nav>
